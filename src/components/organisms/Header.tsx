    ...
    <TooltipProvider>
      <div className="text-center mb-8">
        <div className="flex items-center justify-center gap-3 mb-4">
          ...
          <Text as="h1" variant="title" className="text-4xl font-bold bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent">
            Atomic Todo Manager
          </Text>
        </div>
        <Text variant="body" className="text-gray-500 text-lg mb-6">
